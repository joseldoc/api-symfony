...
// Returns the private 'App\Repository\DroitRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DroitRepository.php';

return $this->privates['App\\Repository\\DroitRepository'] = new \App\Repository\DroitRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
